...
export class Login extends React.Component {
  ...
  render() {
    ...
    <label className="alert alert-danger" style={{visibility:"hidden",fontSize:"15px"}}id="msg"></label>
        ...
        <Link to={{pathname:'../Game',nameprop:'anany'}}>
          <button onClick={this.handleClick} type="button" className="big-button" style={{backgroundColor:"#BED9A6",fontFamily:"CustomFont",color:"black"}}>
            Play
          </button>
          </Link>
